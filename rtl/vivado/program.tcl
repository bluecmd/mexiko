...
create_hw_cfgmem -hw_device [lindex [get_hw_devices] 0] -mem_dev  [lindex [get_cfgmem_parts {mt28gu512aax1e-bpi-x16}] 0]

#set_property PROGRAM.ADDRESS_RANGE  {use_file} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices] 0 ]]
#set_property PROGRAM.FILE_1 {mexiko.mcs} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices] 0]]
